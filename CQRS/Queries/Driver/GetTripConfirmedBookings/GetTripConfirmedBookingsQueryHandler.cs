...
{
    public class GetTripConfirmedBookingsQueryHandler
           : IRequestHandler<GetTripConfirmedBookingsQuery, Response<PaginatedResult<BookingStatusResponseDto>>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public GetTripConfirmedBookingsQueryHandler(
        ...
        public async Task<Response<PaginatedResult<BookingStatusResponseDto>>> Handle(
            GetTripConfirmedBookingsQuery request,
