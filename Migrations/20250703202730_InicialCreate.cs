        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarLicenseImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SelfieImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromGovernorateId = table.Column<int>(type: "int", nullable: false),
                    ToGovernorateId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Trips_Governorates_FromGovernorateId",
                        column: x => x.FromGovernorateId,
                        principalTable: "Governorates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Trips_Governorates_ToGovernorateId",
                        column: x => x.ToGovernorateId,
                        principalTable: "Governorates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLong = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripTrackings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripTrackings_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_RaterId_RatedId_TripId",
                table: "Ratings",
                columns: new[] { "RaterId", "RatedId", "TripId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_FromGovernorateId",
                table: "Trips",
                column: "FromGovernorateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_ToGovernorateId",
                table: "Trips",
                column: "ToGovernorateId");

            migrationBuilder.CreateIndex(
                name: "IX_TripTrackings_TripId",
                table: "TripTrackings",
                column: "TripId");
        }
